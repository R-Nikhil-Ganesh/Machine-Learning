...
+ Used a train test split to accurately evaluate the models.
---
without advanced methods such as cv, hyperparameter tuning etc, I was able to get an accuracy of 80% on both the models.